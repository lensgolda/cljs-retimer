...
var G__10180 = devtools.prefs.pref.call(null,v);
v = G__10180;
continue;
} else {
return v;
...
}catch (e10183){var _e__9937__auto__ = e10183;
return false;
}})();
...
}catch (e10187){var _e__9937__auto__ = e10187;
return false;
}})();
...
}catch (e10189){var _e__9937__auto__ = e10189;
return false;
}}
}
});
...
var vec__10191 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__10191,(0),null);
var name = cljs.core.nth.call(null,vec__10191,(1),null);
...
return cljs.core.some.call(null,(function (p1__10194_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__10194_SHARP_);
}),template);
});
