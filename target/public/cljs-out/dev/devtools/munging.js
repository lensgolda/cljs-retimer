...
var o10078 = temp__5733__auto__;
var temp__5733__auto____$1 = (o10078["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o10079 = temp__5733__auto____$1;
return (o10079["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__9930__auto__ = f;
return (o__9930__auto__["toString"]).call(o__9930__auto__);
} else {
return "";
}
}catch (e10080){var _ = e10080;
return "";
}});
...
try{var o__9930__auto___10082 = t;
(o__9930__auto___10082["cljs$lang$ctorPrWriter"]).call(o__9930__auto___10082,t,writer);
}catch (e10081){var __10083 = e10081;
}
...
var char_code = (function (){var o__9930__auto__ = (new String(char$));
return (o__9930__auto__["charCodeAt"]).call(o__9930__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__9930__auto__ = String;
return (o__9930__auto__["fromCharCode"]).call(o__9930__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__10084 = num_code;
switch (G__10084) {
case (1):
return (185);
...
var o__9930__auto__ = String;
return (o__9930__auto__["fromCharCode"]).call(o__9930__auto__,superscript_code);
});
/**
...
}catch (e10086){var _e__9937__auto__ = e10086;
return false;
}})())){
...
var vec__10087 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__10087,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o10090 = temp__5733__auto__;
var temp__5733__auto____$1 = (o10090["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o10091 = temp__5733__auto____$1;
return (o10091["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__10094){
var vec__10095 = p__10094;
var ns_detector = cljs.core.nth.call(null,vec__10095,(0),null);
...
var G__10101 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__10102 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__10101;
remaining_tokens = G__10102;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq10092){
...
var vec__10106 = cljs.core.split_with.call(null,(function (p1__10105_SHARP_){
return cljs.core.not_EQ_.call(null,p1__10105_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__10106,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__10106,(1),null);
...
var vec__10109 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__10109,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__10109,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__10112 = cljs.core.rest.call(null,remaining_tokens);
var G__10113 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__10112;
name_tokens = G__10113;
continue;
} else {
...
var vec__10116 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__10116,(0),null);
var arity = cljs.core.nth.call(null,vec__10116,(1),null);
var vec__10119 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__10119,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__10119,(1),null);
var vec__10122 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__10122,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__10122,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__10122,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__10122,(3),null);
...
var vec__10128 = result;
var munged_ns = cljs.core.nth.call(null,vec__10128,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__10128,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__10128,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__10128,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__10128,(4),null);
var arity = cljs.core.nth.call(null,vec__10128,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__10132 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__10132,(0),null);
var args = cljs.core.nth.call(null,vec__10132,(1),null);
var vec__10135 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__10135,(0),null);
var name = cljs.core.nth.call(null,vec__10135,(1),null);
...
var G__10138 = (arity + (1));
var G__10139 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__10140){
var vec__10141 = p__10140;
var arity = cljs.core.nth.call(null,vec__10141,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__10141,(1),null);
...
return cljs.core.get.call(null,arities,p1__10144_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__10145_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__10148){
var vec__10149 = p__10148;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__10149,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq10146){
var G__10147 = cljs.core.first.call(null,seq10146);
var seq10146__$1 = cljs.core.next.call(null,seq10146);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10147,seq10146__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__10157__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__10157__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__10157__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__10157__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__10158 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__10158,(0),null);
var fn_name = cljs.core.nth.call(null,vec__10158,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__10158,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__10158,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__10158,(4),null);
var arity = cljs.core.nth.call(null,vec__10158,(5),null);
...
var o__9930__auto__ = f;
return (o__9930__auto__["getBasis"]).call(o__9930__auto__);
});
/**
...
}catch (e10162){var _e__9937__auto__ = e10162;
...
var G__10163 = (obj[cljs.core.first.call(null,path)]);
var G__10164 = cljs.core.rest.call(null,path);
obj = G__10163;
path = G__10164;
continue;
} else {
...
return (function (accum,p__10165){
var vec__10166 = p__10165;
var bit = cljs.core.nth.call(null,vec__10166,(0),null);
var protocol = cljs.core.nth.call(null,vec__10166,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__10169){
var vec__10170 = p__10169;
var ns = cljs.core.nth.call(null,vec__10170,(0),null);
var name = cljs.core.nth.call(null,vec__10170,(1),null);
var selector = cljs.core.nth.call(null,vec__10170,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__10175,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__10175,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__10175,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__10173_SHARP_){
return (obj[cljs.core.first.call(null,p1__10173_SHARP_)]);
});})(name,sorted_matches,vec__10175,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
