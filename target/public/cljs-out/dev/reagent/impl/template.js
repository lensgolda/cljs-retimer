...
var G__8998 = o;
goog.object.set(G__8998,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__9000__i < G__9000__a.length) {G__9000__a[G__9000__i] = arguments[G__9000__i + 0]; ++G__9000__i;}
  args = new cljs.core.IndexedSeq(G__9000__a,0,null);
} 
...
var G__9002 = o;
goog.object.set(G__9002,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__9006 = props;
var G__9006__$1 = ((((!((id == null))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__9006,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__9006);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__9006__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__9006__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__9007 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__9007,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__9007;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__9008){
...
var on_write = cljs.core.get.call(null,map__9009__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__9009,map__9009__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__9009,map__9009__$1,on_write))
);
} else {
...
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__9011_SHARP_);
});})(v,value,on_change))
;
} else {
return null;
...
var vec__9014 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__9014,(0),null);
var id = cljs.core.nth.call(null,vec__9014,(1),null);
var className = cljs.core.nth.call(null,vec__9014,(2),null);
...
var temp__5739__auto___9018 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5739__auto___9018 == null)){
} else {
var key_9019 = temp__5739__auto___9018;
...
var temp__5739__auto___9020 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5739__auto___9020 == null)){
} else {
var key_9021 = temp__5739__auto___9020;
jsprops.key = key_9021;
}
...
var temp__5739__auto___9022 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5739__auto___9022 == null)){
} else {
var key_9023 = temp__5739__auto___9022;
jsprops.key = key_9023;
}
...
var G__9024 = n;
if(cljs.core._EQ_.call(null,"",G__9024)){
return x;
} else {
if(cljs.core._EQ_.call(null,null,G__9024)){
return x;
} else {
...
args__4534__auto__.push((arguments[i__4532__auto___9028]));
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq9025){
...
break;
default:
var G__9032 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__9032;
continue;
...
var ctx = ({});
var vec__9034 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__9034,(0),null);
var derefed = cljs.core.nth.call(null,vec__9034,(1),null);
...
var G__9037 = (cljs.core.count.call(null,argv) - first_child);
switch (G__9037) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__9037){
